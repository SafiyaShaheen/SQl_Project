...
/*Q4:Which city has the best customers? We would throw a
promotional music festival in the city we made the most
money. Write a query that returns one city that has the 
highest Sum of invoice totals. Return both city name and
...
/*Q5: Who is the best customer ? the customer who spend 
more money will be declared as the best customer. Write a
...
/*Moderate*/
/* Q1: Write query to return the email, firstname, lastname, and genre of all rock music listeners
...
Write a query to return customer name, artist name and total spent*/
 ...
 /* Q2: want to find out the most popular genre for each country*/
